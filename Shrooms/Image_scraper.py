...
class ImageScrapper():
    ...
    def fetch_image_urls(self, max_links_to_fetch:int, wd:webdriver, sleep_between_interactions:int=1, exact_match=False):
        ...
        while image_count < max_links_to_fetch:
            ...
            for img in tqdm(thumbnail_results[results_start:number_results], 
                ...
                try:
                    ...
                    time.sleep(2)
                    return
                    load_more_button = wd.find_elements(By.CSS_SELECTOR, '.mye4qd')      # This .mye4qd is specific to google
                    if load_more_button:
    ...
    def persist_image(self, url:str):
        ...
        try:
            ...
            print(f'Failed to access image url {url} - {e}')
